...
class CombiningApproachTrainer(DefaultTrainer):
    ...
    def __init__(self, cfg):
        ...
        # EMA parameters
        self.ema_decay = cfg.SOLVER.EMA_DECAY if hasattr(cfg.SOLVER, 'EMA_DECAY') else 0.999
    ...
    def test(self, cfg, model, evaluators=None):
        ...
        model.load_state_dict(self.ema_model.state_dict())  # Using self.ema_model here
        ...
        # Revert to original weights after evaluation
    ...
    def test_with_TTA(self, cfg, model):
        logger = logging.getLogger("detectron2.trainer")
        logger.info("Running inference with test-time augmentation ...")
        model = SemanticSegmentorWithTTA(cfg, model)
        evaluators = [
            self.build_evaluator(cfg, name, output_folder=os.path.join(cfg.OUTPUT_DIR, "inference_TTA"))
