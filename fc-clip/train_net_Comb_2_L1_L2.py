...
class CombiningApproachTrainer(DefaultTrainer):
    ...
    def run_step(self):
        ...
        # Add the individual losses together without combining logits
        total_loss = sum(loss_dict_one.values()) + sum(loss_dict_model_two.values())
        ...
        # Sum both losses for final loss computation
        losses = total_loss
