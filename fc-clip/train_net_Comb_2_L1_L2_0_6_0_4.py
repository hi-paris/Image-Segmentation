...
class CombiningApproachTrainer(DefaultTrainer):
    ...
    def run_step(self):
        ...
        # Define the weighting factors for the two models
        alpha1 = 0.6  # weight for model one
        alpha2 = 0.4  # weight for model two
    
        # Add the individual losses together with weights
        total_loss = alpha1 * sum(loss_dict_one.values()) + alpha2 * sum(loss_dict_model_two.values())
        ...
        # Sum both weighted losses for final loss computation
        losses = total_loss
