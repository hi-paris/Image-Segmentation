...
class DecoderAdapter(nn.Module):
    ...
    def __init__(self, input_dim, bottleneck_dim):
        super().__init__()
        # Use conv and BatchNorm instead of LayerNorm
...
class FCCLIP(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        # Apply DecoderAdapter to res4 layer
        res4_dim = self.backbone.output_shape()['res4'].channels
        bottleneck_dim = 256  # Can be adjusted as needed
        self.decoder_adapter_res4 = DecoderAdapter(input_dim=res4_dim, bottleneck_dim=bottleneck_dim)
    ...
    def prepare_class_names_from_metadata(self, metadata, train_metadata):
        ...
        try:
            ...
            class_names = split_labels(metadata.thing_classes)  # could be for insseg where only thing_classes are available
    ...
    def forward(self, batched_inputs):
        ...
        # Apply DecoderAdapter to res4 features
        res4_features = features['res4']
