...
class FCCLIP(nn.Module):
    ...
    def forward(self, batched_inputs):
        ...
        """logger.info("Features  'stem' ")
        logger.info(features['stem'])
        logger.info("Features  'res2'  ")
        logger.info(features['res2'])
        logger.info("Features   'res3'  ")
        logger.info(features['res3'])
        logger.info("Features  'res4'  ")
        logger.info(features['res4'])
        logger.info("Features   'res5'  ")
        logger.info(features['res5'])
        logger.info("Features 'clip_vis_dense' ")
        logger.info(features['clip_vis_dense']) """
        ...
        """logger.info("outputs pred_logits ")
        logger.info(outputs["pred_logits"])
        logger.info("outputs pred_masks ")
        logger.info(outputs["pred_masks"])
        logger.info("outputs aux_outputs ")
        logger.info(outputs["aux_outputs"])"""
        ...
        if self.training:
            ...
            if "instances" in batched_inputs[0]:
                ...
                """logger.info('targets')
                logger.info(targets)"""
                # Targets is a set of labels and maskes
            else:
                targets = None
            ...
            """logger.info("mask_cls_results")
            logger.info(mask_cls_results)
            logger.info("mask_pred_results")
            logger.info(mask_pred_results)""" 
            ...
            # get the mask pooling fot in vocab and out vocab 
            ...
            mask_cls_results = torch.log(mask_cls_probs + 1e-1)
            ...
            #logger.info([i for i in processed_results[0]["panoptic_seg"]])
            #logger.info(processed_results[0]["panoptic_seg"])
            #exit()
