...
# Config paths 
path_results =  "/tsi/hi-paris/GB/segmentation/Inference_train_data_new/r50_inference_19"
...
path_naive_008=os.path.join(".","cityscapes_panoptic_train_naive_008_r50.json")
path_normal_008=os.path.join(".","cityscapes_panoptic_train_normal_008_r50.json")
path_in_vocab_008=os.path.join(".","cityscapes_panoptic_train_invocab_008_r50.json")
